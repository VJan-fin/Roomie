...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $users = array(
            ['id' => 1, 'name' => 'Viktor', 'email' => 'vikjan94@gmail.com', 'password' => Hash::make('secret'), 'role' => 'admin', 'registration_status' => 'complete',
                'created_at' => Carbon::create(2016, 1, 10, 11, 54, 21, "Europe/Skopje"), 'updated_at' => Carbon::create(2016, 1, 10, 11, 54, 21, "Europe/Skopje")],

            ['id' => 2, 'name' => 'Molly', 'email' => 'molly.bing@gmail.com', 'password' => Hash::make('secret'), 'role' => 'user', 'registration_status' => 'complete',
                'created_at' => Carbon::create(2016, 1, 12, 17, 32, 4, "Europe/Skopje"), 'updated_at' => Carbon::create(2016, 1, 12, 17, 32, 4, "Europe/Skopje")],

            ['id' => 3, 'name' => 'Pete', 'email' => 'pete.pirone@gmail.com', 'password' => Hash::make('secret'), 'role' => 'user', 'registration_status' => 'complete',
